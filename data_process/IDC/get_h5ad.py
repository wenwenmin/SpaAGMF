...
def process_ref(data_dir, name, uni):
    ...
    label_path = data_dir / f'cancer_original/{name[0]}_label.csv'
...
def process_tgt(data_dir, name, uni):
    ...
    label_path = data_dir / 'Visium_IDC_label.txt'
...
if __name__ == '__main__':
    ...
    tgt_dir = Path('xxx') # Modify it to your IDC data directory

    # 2. Define the save directory
    save_dir = Path(__file__).parents[2] / 'data/STHBC2IDC/'
